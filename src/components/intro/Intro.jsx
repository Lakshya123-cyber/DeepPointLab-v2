        ...
        <div className="i-left-wrapper">
          ...
          <div className="i-title">
            <div className="i-title-wrapper">
              ...
              <div className="i-title-item">IT Infrastructure Optimization</div>
              <div className="i-title-item">
          ...
          <br />
          <p className="i-desc">
            Deep Point Lab specializes in expert tech consultancy services that
            empower businesses in the digital landscape. We deliver tailored
            solutions for growth, efficiency, and innovation, helping your
